...
def main():
    ...
    plt.title('BloodMNIST FedAvg: Communication Rounds vs Avg Client Accuracy')
    plt.xlabel('Communication Rounds')
    plt.ylabel('Accuracy (%)')
    plt.grid(True)
    plt.legend()
    plt.savefig('BloodMNIST_fedavg_client_accuracy.png')
    plt.close()

    plt.figure(figsize=(10, 5))
    plt.plot(rounds, history['global_acc'], marker='s', color='red', label='Global Model Acc')
    plt.title('BloodMNIST FedAvg: Communication Rounds vs Global Accuracy')
    plt.xlabel('Communication Rounds')
    plt.ylabel('Accuracy (%)')
    plt.grid(True)
    plt.legend()
    plt.savefig('BloodMNIST_fedavg_global_accuracy.png')
    plt.close()

    plt.figure(figsize=(10, 6))
    plt.plot(rounds, history['avg_client_acc'], marker='o', color='blue', label='Avg Client Acc')
    plt.plot(rounds, history['global_acc'], marker='s', color='red', label='Global Model Acc')
    plt.title('BloodMNIST FedAvg: Communication Rounds vs Federated Accuracies')
    plt.xlabel('Communication Rounds')
    plt.ylabel('Accuracy (%)')
    plt.grid(True)
    plt.legend()
    plt.savefig('BloodMNIST_fedavg_combined.png')
    plt.close()
